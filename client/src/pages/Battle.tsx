    ...
    <div className="container">
      <div className="header">
        ...
        <div className="nav">
          ...
          <Link to="/battle" id="btn-battle" className="nav-btn active" style={{ display: 'none' }}>
      ...
      <div className="section active" id="battle">
        <h2>⚔️ Battle Arena</h2>
        <p>Challenge enemies and compete in epic battles!</p>
        <div className="grid" id="battleContainer"></div>
      </div>
    </div>
  )
}
