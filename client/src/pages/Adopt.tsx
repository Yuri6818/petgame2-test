    ...
    <div className="container">
      <div className="header">
        ...
        <div className="nav">
          ...
          <Link to="/adopt" id="btn-adopt" className="nav-btn active">
      ...
      <div className="section active" id="adopt">
        <h2>🏠 Adoption Center</h2>
        <p>Choose a new familiar to join your adventure!</p>
        <div className="grid" id="adoptContainer"></div>
      </div>
    </div>
  )
}
