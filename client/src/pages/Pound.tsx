  ...
  return (
    <div className="container">
      <div className="header">
        <h1>
          <img src="/img/assets/fabledfamiliarsbannersmall.png" alt="Scroll Icon" style={{ height: '3em', verticalAlign: 'middle', marginRight: '0em' }} />
        </h1>
        ...
        <div className="nav">
          ...
          <Link to="/pound" id="btn-pound" className="nav-btn active">
            <img src="/img/assets/pound-sign.png" className="nav-icon" alt="Pound" /> Pound
          </Link>
          <Link to="/battle" id="btn-battle" className="nav-btn" style={{ display: 'none' }}>
        ...
        <div className="status-bar">
          <div className="status-item">
            <img src="/img/assets/coins.png" className="status-icon" alt="Coins" /> Coins: <span id="coinCount">150</span>
          </div>
          <div className="status-item">
            <img src="/img/assets/dust.png" className="status-icon" alt="Dust" /> Dust: <span id="dustCount">25</span>
          </div>
          <div className="status-item">
            <img src="/img/assets/training-page.png" className="status-icon" alt="Level" /> Level: <span id="playerLevel">1</span>
          </div>
          <div className="status-item">⭐ XP: <span id="playerXP">0</span>/100</div>
      ...
      <div className="section active" id="pound">
        <h2>🐕 Animal Pound</h2>
        <p>Release familiars back into the wild or see those available.</p>
        <div className="grid" id="poundContainer"></div>
      </div>
    </div>
  )
}
